...
const AppDB = (() => {
  const DB_STORAGE_KEY = 'daily-blitz-seasons-sqlite-v1';
  const LEGACY_JSON_KEYS = ['daily-blitz-seasons-v2', 'daily-blitz-seasons-v1', 'math-blitz-date-v1'];
